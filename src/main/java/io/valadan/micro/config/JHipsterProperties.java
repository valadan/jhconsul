package io.valadan.micro.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhconsul@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhconsul API";

        private String description = "jhconsul API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhconsul";
